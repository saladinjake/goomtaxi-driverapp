        ...
        .then(datas => {
          ...
          switch (pageId) {
            ...
            case 'admin-admins':
              ...
              break;
            case 'admin-drivers':
              ApiAdminBotService.runAdminDrivers(
                datas[2].data[0].drivers,
                datas[16].data[0].carsAvailable,
                previledgesRight,
              );
            ...
            case 'admin-plan-package':
              ApiAdminBotService.runPlanPackage(
                datas[5].data[0].individualPlans,
                datas[6].data[0].corporatePlans,
                previledgesRight,
              );
              app.style.display = 'block';
              break;
            case 'admin-sos':
              ...
              break;
            case 'admin-tickets':
              ApiAdminBotService.runAdminTickets(
                datas[8].data[0].intervention,
                datas[1].data[0].admins,
                datas[0].data[0].users,
                previledgesRight,
              );
              app.style.display = 'block';
            ...
            case 'admin-cars-mgt':
              ApiAdminBotService.runAdminCarsMgt(
                datas[16].data[0].carsAvailable,
            ...
            case 'plan-manual-bookings-admin':
              ApiAdminBotService.runAdminPlansManualBookings(
                datas[16].data[0].carsAvailable,
                datas[0].data[0].users,
                previledgesRight,
              );
            ...
            case 'admin-itineraries':
              ApiAdminBotService.runAdminItineraries(
                datas[17].data[0].itineraries,
                datas[2].data[0].drivers,
                previledgesRight,
              );
            ...
            case 'admin-redo-inspection':
              ApiAdminBotService.runAdminInspection(
                datas[24].data[0].inspections,
                datas[23].data[0].carInfo,
                datas[2].data[0].drivers,
                datas[3].data[0].partners,
                previledgesRight,
            ...
            case 'admin-inspection-add':
              ApiAdminBotService.runAdminInspectionAdd(
                'add-inspection',
                datas[0].data[0].users,
                datas[3].data[0].partners,
                previledgesRight,
            ...
            case 'admin-drive-test-add':
              ApiAdminBotService.runAdminDriveTestAdd(
                'add-drive-test',
                datas[0].data[0].users,
                datas[3].data[0].partners,
                previledgesRight,
            ...
            case 'admin-drive-test':
              ApiAdminBotService.runAdminDriveTest(
                datas[25].data[0].testDrive,
                datas[0].data[0].users,
                previledgesRight,
              ); //25
              app.style.display = 'block';
            ...
            case 'admin-previledges':
              ApiAdminBotService.runAdminPreviledges(
                datas[26].data[0].previledges,
                previledgesRight,
              );
              app.style.display = 'block';
              break;
            ...
            case 'admin-repairs':
              ...
              break;
            case 'admin-earnings':
              ApiAdminBotService.runAdminPartnersEarnings(
                datas[34].data[0].earnings,
                datas[3].data[0].partners,
                datas[16].data[0].carsAvailable,
                previledgesRight,
              );
            ...
            case 'admin-retrievals':
              ApiAdminBotService.runAdminCarRetrieval(
                datas[16].data[0].carsAvailable,
                datas[16].data[0].carsAvailable,
                datas[2].data[0].drivers,
                datas[3].data[0].partners,
            ...
            case 'view-retrievals':
              ApiAdminBotService.runAdminCarRetrievalEdit(
                datas[35].data[0].carsNotInUse,
                datas[16].data[0].carsAvailable,
                datas[2].data[0].drivers,
                datas[3].data[0].partners,
                previledgesRight,
