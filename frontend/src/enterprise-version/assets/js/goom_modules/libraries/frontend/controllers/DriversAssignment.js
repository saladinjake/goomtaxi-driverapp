...
export default class DriversAssignement {
  ...
  indexController() {
    ...
    if (JSON.parse(localStorage.getItem('userToken'))) {
      ...
      const urls = [
        baseUrl + '/drivers-assigned-cars/' + user.user.email,
            ...
            trips.map((item, i) => {
              ...
              let template2 = `<tr id="${i}">
                          ...
                          <td class="">${item.destination}</td>
                            ...
                            <td class=""><span class="label label-table ${className}">${
                item.status
              }</span></td>
                            <td class=""></td>

                            <td class="">
                               <a onclick="viewRecordDriverUserItinsDetail(this)" href="#" data-checkmate="${
                                 item.assigned_driver_name
                               }-${item.assigned_driver_email}"  data-id="${
                item._id
              }" data-start_time="${formatDate(
                new Date(item.start_time),
              )}" data-end_time="${formatDate(new Date(item.end_time))}" data-id="${
                item._id
              }" data-no_hours="${item.no_hours}" data-start_location="${
                item.start_location
              }" data-destination="${item.destination}" data-drive_option="${
                item.drive_option
              }"  data-travel_option="${item.travel_option}"  data-username="${
                item.username
              }"  data-email="${item.email}"  data-phone_number="${
                item.phone_number
              }"  id="plancat${item._id}" data-assigned_driver_name="${
                item.assigned_driver_name
              }" data-status="${item.status}" data-id="${
                item._id
              }" data-url="/admin-itinerary-details" class="table-action-btn btn-custom btn-purple"><i class="md md-chevron-right"></i></a>
              ...
              viewModals += `<div style="display:none" id="con-close-modal-${
                item._id
              }" class="fade in mebox" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
                                        <div class="slimScrollBar"> 
                                            <div > 
                                                <div class=""> 
                                                    <button id="close-id" data-id="${
                                                      item._id
                                                    }" onclick="addCloseEffect(this)" type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button> 
                                            ...
                                            item._id
                                          }" class="form-control" data-style="btn-white">
                                          ...
                                          <div class="form-group">
                                                                  ...
                                                                  <select disabled id="assigned_driver${
                                                                    item._id
                                                                  }" class="form-control" data-style="btn-white">
                                                                      
                                                                      <option>${
                                                                        item.assigned_driver_email
                                                                      }</option>
                                                         ...
                                                         <div class=""> 
                                                            <div class="form-group"> 
                                                                ...
                                                                <input  type="text" disabled class="form-control" id="start_time${
                                                                  item._id
                                                                }" placeholder="unlimited" value="${formatDate(
                new Date(item.start_time),
              )}"> 
                                                            </div> 
                                                        </div>
                                                            ...
                                                            <div class="form-group"> 
                                                                ...
                                                                <input type="text" disabled class="form-control" id="drive_option${
                                                                  item._id
                                                                }" value="${
                item.drive_option
              }" placeholder="AE-GX-2211"> 
                                                            </div> 
                                                        </div>
                                                    </div> 
                ...
                item._id
                                                        ...
                                                        <div class=""> 
                                                            <div class="form-group"> 
                                                                ...
                                                                <input value="${
                                                                  item.no_hours
                                                                }"  type="text" disabled class="form-control" id="no_hours${
                item._id
              }" placeholder="unlimited"> 
                                                            </div> 
                                                        </div>
                                                        ...
                                                        <div class="" style="display:none"> 
                                                            <div class="form-group">  
                                                                ...
                                                                )}" disabled class="form-control" id="end_time${
                item._id
              }" placeholder="saladin"> 
                                                            </div> 
                                                            </div>
                                                        ...
                                                        <div class="col-md-12"> 
                                                            ...
                                                            <div class=""> 
	                                                            <div class="form-group">  
	                                                                ...
	                                                                <input value="${
                                                                    item.username
                                                                  }" type="text" disabled class="form-control" id="username${
                item._id
              }" placeholder="saladin"> 
	                                                            </div> 
                                                            </div>
									                        ...
									                        <div class=""> 
	                                                            <div class="form-group"> 
	                                                                ...
	                                                                <inputemail value="${
                                                                    item.email
                                                                  }" type="text" disabled class="form-control" id="email${
                item._id
              }" placeholder=""> 
	                                                            </div> 
                                                            </div>
                                                            ...
                                                            <div class=""> 
	                                                            <div class="form-group"> 
	                                                                ...
	                                                                <input value="${
                                                                    item.phone_number
                                                                  }"  type="text" disabled class="form-control" id="phone_number${
                item._id
              }" placeholder="AE-GX-2211"> 
	                                                            </div> 
                                                            </div>
                                                            ...
                                                            <textarea disabled class="form-control autogrow" id="start_location${
                                                              item._id
                                                            }" placeholder="Description" style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 104px;">${
                item.start_location
              }</textarea>
                                                            ...
                                                            <textarea disabled class="form-control autogrow" id="destination${
                                                              item._id
                                                            }" placeholder="Response" style="overflow: hidden; word-wrap: break-word; resize: horizontal; height: 104px;">${
                item.destination
              }</textarea>
                                                ...
                                                <div class="modal-footer">
                                                  <button id="cancle" data-id="${
                                                    item._id
                                                  }" onclick="addCloseEffect(this)" type="button" class="btn btn-default waves-effect" data-dismiss="modal">Close</button> 
            ...
            trips.map((item, i) => {
              ...
              if (item.status == 'Completed') {
                ...
                let template2 = `<tr id="${i}">
                  ...
                  item.assigned_driver_email
                }"  data-id="${item._id}" data-start_time="${formatDate(
                  new Date(item.start_time),
                )}" data-end_time="${formatDate(new Date(item.end_time))}" data-id="${
                  item._id
                }" data-no_hours="${item.no_hours}" data-start_location="${
