    ...
    return (
      ...
      <div className="content-page page-wrap" id="spread-out">
                ...
                <div className="content" id="view-tickets">
                   ...
                   <a id="portfolio" style={{textAlign:"center",fontSize:"15px"}} href="./drivers-createticket" className="link-to-portfolio hover-target"><i class="md md-add text-info"></i></a>
