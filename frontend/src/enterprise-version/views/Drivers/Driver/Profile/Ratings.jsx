    ...
    <div className="smileybox"> 
        ...
        <div className="profile-text">
          ...
          <div className="rate text-center">
              ...
              <label for="r1" className="check"><input type="checkbox" id="r1" /><i className="em em-weary"></i></label>
              <label for="r2" className="check"><input type="checkbox" id="r2" /><i className="em em-worried"></i></label>
              <label for="r3" className="check"><input type="checkbox" id="r3" /><i className="em em-blush"></i></label>
              <label for="r4" className="check"><input type="checkbox" id="r4" /><i className="em em-smiley"></i></label>
              <label for="r5" className="check"><input type="checkbox" id="r5" /><i className="em em-sunglasses"></i></label>
          </div>
</div>
