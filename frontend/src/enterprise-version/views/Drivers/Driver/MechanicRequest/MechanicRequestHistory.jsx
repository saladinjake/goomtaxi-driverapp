  ...
  render() {
    ...
    return (
      ...
      <div className="content-page page-wrap" id="spread-out">
                ...
                <a id="portfolio" style={{textAlign:"center",fontSize:"15px"}} href="./drivers-request-car-repair" className="link-to-portfolio hover-target"><i class="md md-add text-info"></i></a>
            </div>
