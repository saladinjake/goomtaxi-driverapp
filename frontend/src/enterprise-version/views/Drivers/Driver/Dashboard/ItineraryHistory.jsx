                ...
                <div className="card-box">
                  ...
                  <div className="table-responsive">
                    ...
                    >
                      <thead>
                        <tr>
                          <th data-toggle="true" className="col-lg-4">
                            Created Date
                          </th>
                          <th data-hide="phone" className="col-lg-4">
                            Plan Category
                          </th>
                          <th data-hide="phone" className="col-lg-4">
                            Start Location
                          </th>
                          <th data-hide="phone" className="col-lg-3">
                            Destination
                          </th>
                          <th data-hide="phone" className="col-lg-4">
                            Start Time
                          </th>
                          <th data-hide="phone" className="col-lg-2">
                            Drive Option
                          </th>
                          <th data-hide="phone" className="col-lg-2">
                            Duration (hrs)
                          </th>
                          <th data-hide="all" className="col-lg-2">
                            Status
                          </th>
                        </tr>
                      </thead>
                      <tbody id="tablebody-it"></tbody>
                      <tfoot>
                        <tr>
                          <td colSpan="5">
