...
export default class Dashboard extends Component {
  componentDidMount() {
    ...
    if (localStorage.getItem('userToken')) {
      ...
      document.getElementById('userWelcomeSection').innerHTML =
        'Welcome ' + user.user.firstname + ', How is your day going';
          ...
          <div className="container" id="trips-assigned">
            <div className="row">
              <div className="col-sm-12">
                ...
                <p id="userWelcomeSection" className="text-muted page-title-alt">
                  {' '}
                </p>
              </div>
            </div>
            ...
            <div className="row">
                  ...
                  <div className="widget-bg-color-icon card-box p-t-10 p-b-10">
                    ...
                    <div className="col-lg-6 pull-right text-right">
                      <h3 className="text-dark" style={{ fontSize: '14px' }}>
                        <b className="">Finished Bookings/Trips</b>
                      </h3>
                      ...
                      <p className="text-muted" style={{ display: 'none' }} id="idvalue">
                        No plan id
                      </p>
                    </div>
              ...
              <a id="topup-wallet" href="./drivers-upcomingtrips">
                <div className="col-sm-6  col-md-6 col-lg-3 bg-red">
              ...
              <a id="plan" href="./drivers-profile">
                <div className="col-sm-6  col-md-6 col-lg-3">
                  <div className="widget-bg-color-icon card-box">
                    ...
                    <div className="col-lg-6 pull-right text-right">
                      ...
                      <h3 className="text-dark" style={{ fontSize: '14px' }}>
                        <b className="">
                          <span style={style1}> Profile</span>
                        </b>
                      </h3>
                      <p className="text-muted"></p>
                    </div>
              ...
              <a id="request-car-repair" href="./drivers-ratings">
                <div className="col-sm-6  col-md-6 col-lg-3">
                  <div className="widget-bg-color-icon card-box">
                    <div className="bg-icon bg-icon-custom pull-left">
                    ...
                    <div className="col-lg-6 pull-right text-right">
                      <h3 className="text-dark" style={{ fontSize: '14px' }}>
                        <b className="">
                          Ratings <span style={style1}></span> repair
                        </b>
                      </h3>
                      <p className="text-muted"></p>
                    </div>
                  ...
                  <div className="table-responsive card-box">
                    ...
                    <div className="portlet">
                      <div className="portlet-heading ">
                        <h3 className="portlet-title">Primary Heading</h3>
