        ...
        <div class="column-sos">
          <div className="content-page " id="spread-out">
            <div className="content" id="sos-page">
                            ...
                            <div className="col-lg-3 text-center">
                              <div id="container">
                                <h1 style={{ visibility: 'hidden' }}>
                                  Video and Audio Recording is in session...
                                </h1>
                                <video
                                  id="videoOutput"
                                  autoPlay
                                ...
                                <div>
                                  <button id="play" disabled style={{ visibility: 'hidden' }}>
                                    Play
                                  </button>
                                  <button id="download" disabled style={{ visibility: 'hidden' }}>
                                    Download
                                  </button>
                                </div>
              ...
              <div className="row" id="show-map"></div>
            </div>
