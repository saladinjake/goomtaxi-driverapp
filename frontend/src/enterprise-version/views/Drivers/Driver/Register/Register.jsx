...
export class Register extends Component {
  ...
  render() {
    const styleM = {
      background: '#fff url("public/assets/images/products/home2.jpg") no-repeat fixed left',
    ...
    return (
      <React.Fragment>
        <div
          className="col-lg-8 col-md-6 hidden-md-down hidden-xs hidden-sm "
          id="signup_page"
          style={styleM}
        >
        ...
        <div
          className="col-lg-4 col-md-6 col-sm-12 col-xs-12 pull-right p-l-0 p-r-0"
          style={{ background: '#fff', height: '100%' }}
        >
          <div className="card-box p-l-0 p-r-0" id="drivers-signup">
            <div className="panel-heading p-b-0">
              <h1
                className="text-custom m-t-40 m-b-20 text-left"
                style={{ fontWeight: '700', letterSpacing: '3px' }}
              >
                Sign up
              </h1>
              <a href="/" className="btn-link" style={{ textDecoration: 'none' }}>
            ...
            <div className="panel-body p-t-0" style={{ height: '100%', background: '#fff' }}>
              ...
              <form
                id="sign-form"
                className="form m-t-10"
                method="POST"
                action="https://goomtaxibackendapi.herokuapp.com/api/v1/auth/drivers-signup"
              >
                ...
                <div className="form-group text-center m-t-40">
                  <div className="col-xs-12">
                    <button
                      ...
                      id="signup_btn"
                      className="btn btn-info btn-block text-uppercase waves-effect waves-light btn-facebook waves-effect waves-light m-t-20"
                      type="submit"
                    >
                      Register
                    </button>
                ...
                <div className="form-group m-b-0 text-center">
                  <div className="col-sm-12">
                    <a
                      style={{ width: '60px', marginRight: '5px', height: '40px' }}
                      href="https://goomtaxibackendapi.herokuapp.com/api/v1/auth/google"
                      className=""
                    >
                      <img
                    ...
                    <a
                      style={{ width: '60px', marginRight: '5px', height: '40px' }}
                      href="https://goomtaxibackendapi.herokuapp.com/api/v1/auth/instagram"
                      className=""
                    >
                      <img
                    ...
                    <a
                      style={{ width: '60px', marginRight: '5px', height: '40px' }}
                      href="https://goomtaxibackendapi.herokuapp.com/api/v1/auth/facebook"
                      className=""
                    >
                      <img
                        style={{ width: '25px', height: '25px' }}
                        src="public/assets/images/facebook2.png"
                      />
                    </a>
                  </div>
                </div>
            ...
            <div className="row m-t-20">
              <div className="col-sm-12 text-center">
                <p>
                  ...
                  <a href="./" className="text-primary m-l-5">
                    <b>Login</b>
                  </a>
                </p>
              </div>
