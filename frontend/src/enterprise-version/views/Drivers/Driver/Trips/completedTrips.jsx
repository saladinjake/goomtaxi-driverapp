...
class CompletedTripsContent extends Component {

    render() {  
        return [
            <React.Fragment>  
  <div className="content-page" id="spread-out">
    <div className="container" id="completed-trips">
      {/* Page-Title */}
      <div className="row">
            ...
            <div className="content">
                <div className="container" >
                    ...
                    <div className="row">
                            ...
                            className="btn btn-default waves-effect waves-light pull-left m-b-10 gobackFor"><i className="md  md-chevron-left"></i> Back to List</a> </div>
                            <div className="col-lg-8"><h4 className="m-b-10 header-title">Detail Trip <span className="m-l-10 text-purple font-13"><b id="user-id"></b></span></h4></div>
...
export default CompletedTripsContent;
