    ...
    return (
      <React.Fragment>
        <div id="pass_forgot_page">
          ...
          <div className="wrapper-page" id="recovery-drivers">
            <div className=" card-box">
              ...
              <div className="panel-body">
                <form
                  method="post"
                  id="e-form"
                  action="https://goomtaxibackendapi.herokuapp.com/api/v1/auth/forgot_password"
                  role="form"
                ...
                >
                  ...
                  <div className="form-group m-b-0">
                    <div className="col-xs-12 col-md-12 col-sm-12">
                      ...
                      <input
                        ...
                        className="btn btn-primary  w-md cd-add-to-cart js-cd-add-to-cart"
                        value="Reset"
                      />
                      <br />
                    </div>
                  ...
                  <div className="row m-t-30">
                    <div className="col-sm-12 text-center">
                      <p>
                        <a href="./dasboard-drivers" className="text-primary m-l-5">
                          <b>I remember my password</b>
                        </a>
                      </p>
                    </div>
                  </div>
